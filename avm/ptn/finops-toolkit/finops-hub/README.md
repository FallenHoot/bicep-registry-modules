...
| `Microsoft.Kusto/clusters/databases/scripts` | 2024-04-13 | <ul style="padding-left: 0px;"><li>[AzAdvertizer](https://www.azadvertizer.net/azresourcetypes/microsoft.kusto_clusters_databases_scripts.html)</li><li>[Template reference](https://learn.microsoft.com/en-us/azure/templates/Microsoft.Kusto/2024-04-13/clusters/databases/scripts)</li></ul> |
...
| `Microsoft.Kusto/clusters/privateEndpointConnections` | 2024-04-13 | <ul style="padding-left: 0px;"><li>[AzAdvertizer](https://www.azadvertizer.net/azresourcetypes/microsoft.kusto_clusters_privateendpointconnections.html)</li><li>[Template reference](https://learn.microsoft.com/en-us/azure/templates/Microsoft.Kusto/2024-04-13/clusters/privateEndpointConnections)</li></ul> |
...
| [`dataExplorerRawRetentionInDays`](#parameter-dataexplorerrawretentionindays) | int | Number of days of data to retain in the Data Explorer *_raw tables. Default: 0 (delete after normalization). |
...
| [`enableManagedExportsOverride`](#parameter-enablemanagedexportsoverride) | bool | Enable managed exports where your FinOps hub instance will create and run Cost Management exports on your behalf. When true, requires billing scopes to be configured. Default: true. |
...
| [`fabricCapacityUnits`](#parameter-fabriccapacityunits) | int | Number of capacity units for the Microsoft Fabric capacity. This is the number in your Fabric SKU (e.g., Trial = 1, F2 = 2, F64 = 64). Used to manage parallelization in data pipelines. Default: 2. |
...
Number of days of data to retain in the Data Explorer *_raw tables. Default: 0 (delete after normalization).
...
### Parameter: `enableManagedExportsOverride`

Enable managed exports where your FinOps hub instance will create and run Cost Management exports on your behalf. When true, requires billing scopes to be configured. Default: true.
...
Number of days of data to retain in the msexports container. Default: 0 (delete after ingestion).
...
Number of capacity units for the Microsoft Fabric capacity. This is the number in your Fabric SKU (e.g., Trial = 1, F2 = 2, F64 = 64). Used to manage parallelization in data pipelines. Default: 2.
...
| `configDeployed` | bool | Indicates whether settings.json was deployed to the config container. |
